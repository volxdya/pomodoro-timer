            ...
            <div className="currentDay">
                ...
                {workTime.get() ? (
                    <p>
                        ...
                        <span className="allTime"> {Math.ceil(workTime.get() / 60)} минуты</span>
                    </p>
                ) : (
                    <p>Нет данных</p>
                )}
            ...
            <div className="pomodoros mt-4">
                <div className="d-flex justify-content-center main">
                    ...
                    {countPomodoros.get() > 0 && (
                        <p className="countPomodorosStatistic mt-3">x {countPomodoros.get()}</p>
                    )}
                </div>
                {countPomodoros.get() > 0 && (
                    <div className="bottomPomodoros">{countPomodoros.get()} {text}</div>
                )}
            </div>
        </div>
    )
